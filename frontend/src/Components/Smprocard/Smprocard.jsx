  ...
  return (
    <div className='mainsmProcard border-brand-skin rounded-brand'>
        ...
        <div className="mainsmProductcardData p-2">
            <Link to={`/${props.category}/${props.name}`} className='nav-link'><p className="mainsmProductcardName bricolage-bold text-capitalize mb-0 text-brand-blue">{props.name.slice(0, 9)}...</p></Link>
