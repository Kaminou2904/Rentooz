    ...
    return (
        <div className='mainHome container p-0'>
            ...
            <div className="hiddenText px-4" style={{display: hiddenTxt}}>
                ...
                <p className="whyTxt mb-3 lh-sm text-gray">Pedestal Fan on Rent In Pune <br />
                ...
                <p className="whyTxt mb-3 lh-sm text-gray">Portable AC on Rent In Pune <br />
                ...
                <p className="whyTxt mb-3 lh-sm text-gray">Electric Heater on Rent In Pune <br />
