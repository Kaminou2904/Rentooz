...
function Buydetail() {
    ...
    const formattedPro = proname.replace(/-/g, ' ').replace(' in pune', '');
    ...
    return (
        <div className='mainDetail bg-brand-blue' style={{ height: mainheight }}>
            ...
            <div className="mainDetailHeader px-4 d-flex align-items-center container">
                ...
                <p className="mb-0 bricolage-bold text-white text-capitalize w-75 ms-4 fs-5">Buy {foundPro.cate} in Pune</p>
            </div>
