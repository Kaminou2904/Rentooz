...
function Detail() {
    ...
    const [bookpopup, setBookpopup] = useState('-100vh');
    const [mainheight, setMainheight] = useState('auto');
    const [loadingpopup, setLoadingpopup] = useState('-100vh');
    const [thankpopup, setThankpopup] = useState('-100vh');
        ...
        <div className='mainDetail bg-brand-skin' style={{height: mainheight}}>
            ...
            <div className="detailProContainer rounded-pill rounded-bottom-0 bg-white">
                ...
                <div className="detailProData mt-4 container px-4">
                    ...
                    <p className="mainDetailProAboutTxt mb-0 text-muted bricolage-regular mt-3">Ek number billa mist fan tera ghar sook jayge
                        isme, 10 hazar deposit 2 hazar bhada ab ye idhar milega, Kya Bolte Company aajao fan leleo machao.</p>
                </div>
                ...
                <div className="checkBtnWrap container py-1 mt-2">
                    <button className='checkBtn btn bg-brand-skin text-uppercase py-2 w-100 text-white bricolage-bold fs-4' onClick={()=>{
                        setBookpopup('0vh'); setMainheight('100vh')
                    }}>Check Dates</button>
                </div>

                <div className="bookingPopupCont px-3" style={{bottom: bookpopup}} onClick={()=> {
                    setMainheight('auto')
                    }}>
                    <div className="extarDiv" onClick={()=> setBookpopup('-100vh')}></div>
                ...
                <div className="loadingCont px-3" style={{bottom: loadingpopup}}>
