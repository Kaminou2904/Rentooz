...
import Data from '../../Data/Buyproduct.json'
...
function Buylisting() {
    ...
    const formattedCate = category.replace(/-/g, ' ').replace(' in pune', '');
                    ...
                    <div className="cardWrap row p-0 justify-content-start">
                        {
                            formattedCate === 'mist fan parts' ? (
                                ...
                                formattedCate === 'View All' ? (
                                    proarr.map((data) => (
                                        <Lisitngcard key={data.id} img={data.img[0]} name={data.name} keyfeat={data.keyfeat} price={data.price} cate={data.cate} buy={data.buy} />
                                    ))
                                ) : (
                                    listData.map((data) => (
                                        <Lisitngcard key={data.id} img={data.img[0]} name={data.name} keyfeat={data.keyfeat} price={data.price} cate={data.cate} buy={data.buy} />
