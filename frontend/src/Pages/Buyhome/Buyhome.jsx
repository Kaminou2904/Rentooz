...
import Cardgroupbuy from '../../Components/Cardgroup/Cardgroupbuy';
    ...
    return (
        <div className='mainHome container p-0'>
            ...
            <div className="testDiv my-5 px-4">
                ...
                <Slider {...caroSettings}>
                    <Cardgroupbuy name="silver mist fan" name1="silent air cooler 75 ltrs" name2="portable AC 1.5 ton" />
                    <Cardgroupbuy name="electric heater" name1="air cooler 100 ltrs" name2="pedestal fan 26 inch" />
                    <Cardgroupbuy name="portable AC" name1="black mist fan" name2="silent air cooler 75 ltrs" />
                </Slider>
            </div>

            <div className="ourProducts mt-4">
                <p className="heading fs-3">Newly Launched Products</p>
            ...
            <div className="callToActionDiv">
                <h1 className="grayText text-gray fs-6 mb-0 mt-3 px-5 lh-sm bricolage-bold text-capitalize text-center">Elevate Your Pune Events with Premium Event Material for Purchase.</h1>
                <h2 className="grayText text-brand-blue fs-6 px-4 mb-0 lh-sm bricolage-extrabold text-capitalize text-center">Explore our wide range of products — from portable ACs to mist fan, air coolers to electric heaters.</h2>
            ...
            <div className="aboutRentooze px-4 mt-5">
                ...
                <p className="aboutTxt mb-0 text-gray bricolage-medium mt-1">At Rentooze, we're your trusted partner for buying event materials that add convenience and charm to your Pune occasions. With a focus on providing top-notch solutions, we offer an extensive selection of items for purchase, including portable ACs, pedestal fan, mist fan, air coolers, and electric heaters. Our dedication is to ensure your Pune events are a seamless and comfortable experience.</p>
            </div>
            ...
            <div className="services d-flex flex-wrap justify-content-center mt-5 px-4">
                ...
                <div className="serviceCard col-md-6 mb-2 text-center">
                    ...
                    <h2 className="mb-0 bricolage-bold text-brand-blue fs-6">Buy Portable AC in Pune</h2>
                    <p className="serviceTxt text-gray mb-0 mt-1">Stay cool this summer with Rentooze's range of Portable ACs for sale in Pune. Beat the heat hassle-free with our efficient, affordable, and convenient cooling solutions. Don't let the sweltering heat get to you - choose Rentooze for instant, long-term relief!</p>
                </div>
                <div className="serviceCard col-md-6 mb-2 text-center">
                    <div className="serviceCardImg mt-3">
                        <img src="/images/2Fan.png" alt="service icon" className='img-fluid' />
                    </div>
                    <h2 className="mb-0 bricolage-bold text-brand-blue fs-6">Buy Pedestal Fan in Pune</h2>
                    <p className="serviceTxt text-gray mb-0 mt-1">Rentooze offers a wide range of Pedestal Fan for sale in Pune. Stay cool with our efficient, adjustable-height fans, perfect for both indoor and outdoor use. They're energy-efficient and quiet, providing comfort without high electricity costs or noise disturbances. Beat the heat affordably with Rentooze—shop now and enjoy a cool Pune summer!</p>
                </div>
                <div className="serviceCard col-md-6 mb-2 text-center">
                    <div className="serviceCardImg mt-3">
                        <img src="/images/3Mist Fan.png" className='img-fluid p-2' alt="service icon" />
                    </div>
                    <h2 className="mb-0 bricolage-bold text-brand-blue fs-6">Buy Mist Fan</h2>
                    <p className="serviceTxt text-gray mb-0 mt-1">Revitalize your events in Pune with Rentooze's exclusive Mist Fan for sale! Don’t miss out on the cooling sensation—our Mist Fan are the key to unforgettable outdoor gatherings. Grab the ultimate cooling solution today and make every event a cool success.</p>
                </div>
                <div className="serviceCard col-md-6 mb-2 text-center">
                    <div className="serviceCardImg mt-3">
                        <img src="/images/Heater.png" className='img-fluid p-2' alt="service icon" />
                    </div>
                    <h2 className="mb-0 bricolage-bold text-brand-blue fs-6">Buy Electric Heaters</h2>
                    <p className="serviceTxt text-gray mb-0 mt-1">Are you looking to beat the winter chill in Pune? Look no further! We offer top-notch Electric Heaters for sale in Pune. Stay warm and cozy with our efficient Electric Heaters. Don’t let the cold get to you—buy an Electric Heater today and enjoy the warmth you deserve.</p>
                </div>
                <div className="serviceCard col-md-6 mb-2 mt-0 text-center">
                    <div className="serviceCardImg mt-3">
                        <img src="/images/COOLER.png" className='img-fluid' alt="service icon" />
                    </div>
                    <h2 className="mb-0 bricolage-bold text-brand-blue fs-6">Buy Air Coolers</h2>
                    <p className="serviceTxt text-gray mb-0 mt-1">Whether you're planning a special event or just need daily cooling relief, our air coolers are your ideal solution. Beat the heat this summer with our top-notch air coolers available for sale in Pune, including Hadapsar, Kothrud & more.</p>
                </div>
            </div>
            ...
            <div className="whyDiv px-4 mt-5 pt-3">
                ...
                <div className="whyCard mb-3">
                    {/* <p className="mb-0 lh-sm text-gray bricolage-bold">Quality Products:</p> */}
                    <p className="whyTxt mb-0 lh-sm text-gray">Planning an event in Pune? Look no further than Rentooze for all your cooling and heating needs. We provide a wide range of event materials for purchase, ensuring your event is comfortable and memorable.</p>
                </div>
                <div className="whyCard mb-3">
                    {/* <p className="mb-0 lh-sm text-gray bricolage-bold">Wide Selection:</p> */}
                    <p className="whyTxt mb-0 lh-sm text-gray">Discover the best event cooling and heating solutions in Pune with Rentooze. We offer Mist Fans, Pedestal Fans, Portable ACs, Electric Heaters, Air Coolers, and Mist Fan Parts for sale. Get quality event materials today!</p>
                </div>
                <div className="whyCard mb-3">
                    {/* <p className="mb-0 lh-sm text-gray bricolage-bold">Reliable Service:</p> */}
                    <p className="whyTxt mb-0 lh-sm text-gray">Rentooze is a premier event materials supplier based in Pune, committed to making your events unforgettable. With a focus on customer satisfaction, we offer top-notch Mist Fans, Pedestal Fans, Portable ACs, Electric Heaters, Air Coolers, and Mist Fan Parts. Our dedication to quality products and service sets us apart in the industry.</p>
                </div>
            ...
            <div className="hiddenText px-4" style={{ display: hiddenTxt }}>
                <p className="whyTxt mb-3 lh-sm text-gray">Buy a Mist Fan in Pune to add a refreshing touch to your events. Our Mist Fans are designed to cool large areas efficiently, ensuring a comfortable atmosphere for your guests. Elevate your event in Pune to new heights of comfort by purchasing our state-of-the-art Mist Fans. Designed to efficiently cool expansive areas, these fans guarantee a refreshing atmosphere that will leave a lasting impression on your guests. Imagine a gentle breeze carrying a fine mist, transforming your outdoor wedding, corporate gathering, or any special occasion into an oasis of cool tranquility. Our Mist Fans not only provide relief from the heat but also add a touch of sophistication to your event, ensuring that every moment is enjoyed in comfort.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Our purchasing process is seamless, allowing you to focus on the other aspects of event planning. With an eco-friendly approach, our Mist Fans use water efficiently, minimizing environmental impact. Make a statement at your event – prioritize guest comfort and well-being. Contact us now to secure your Mist Fan purchase and guarantee a cool and memorable experience for everyone attending your event in Pune.</p>

                <h2 className='fs-5 bricolage-bold mb-0'>Buy Pedestal Fan in Pune</h2>
                <p className="whyTxt mb-3 lh-sm text-gray">
                    Keep your event cool and breezy with our Pedestal Fans for sale in Pune. These fans are portable, making them easy to place in any corner, providing excellent airflow. Beat the heat at your event in Pune with our Pedestal Fans available for sale. Ensure a comfortable atmosphere for your guests as they enjoy the festivities in a cool and breezy environment. Our Pedestal Fans are not just functional; they add a touch of convenience to any occasion. Their portability allows for flexible placement, ensuring optimal airflow in any corner of your venue. Whether it's an outdoor celebration or an indoor gathering, our Pedestal Fans are the perfect solution to keep everyone cool and content.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Say goodbye to sweaty discomfort and hello to a refreshing ambiance. Our Pedestal Fans are designed to provide efficient cooling while being easy to set up and operate. Don't let the rising temperatures put a damper on your event—purchase our Pedestal Fans and create an inviting space where your guests can relax and enjoy every moment. Contact us today to secure your Pedestal Fan and make sure your event in Pune is not just memorable but also pleasantly cool.</p>

                <h2 className='fs-5 bricolage-bold mb-0'>Buy Portable AC in Pune</h2>
                <p className="whyTxt mb-3 lh-sm text-gray">
                    Beat the heat with our Portable ACs available for sale in Pune. These AC units are compact, powerful, and energy-efficient, ensuring a cool environment for your event. Stay cool and comfortable in Pune's sweltering heat by purchasing our top-of-the-line Portable Air Conditioners. Perfect for events, our compact yet powerful AC units are designed to provide efficient cooling wherever you need it. Whether you're hosting a party, conducting a business event, or simply want to keep your indoor space comfortable, our Portable ACs are the ideal solution. With easy portability and user-friendly features, our units guarantee a refreshing atmosphere without the hassle of a permanent installation.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Our Portable ACs not only deliver exceptional cooling performance but also prioritize energy efficiency, ensuring you stay cool without breaking the bank. Beat the heat and create a pleasant environment for your guests or colleagues with our reliable and affordable solutions. Don't let the rising temperatures dampen your plans – choose our Portable ACs for a cool and enjoyable experience in Pune. Contact us today to secure your purchase and make your event a refreshing success.</p>

                <h2 className='fs-5 bricolage-bold mb-0'>Buy Electric Heater in Pune</h2>
                <p className="whyTxt mb-3 lh-sm text-gray">
                    For chilly evenings, our Electric Heaters for sale in Pune are the perfect solution. Create a cozy ambiance for your guests with our reliable heating options. Transform your chilly evenings into warm and inviting gatherings with our Electric Heaters available for sale in Pune. Embrace the comfort of a cozy ambiance for your guests as our reliable heating solutions provide the perfect remedy for the winter chill. Whether you're hosting a party, event, or just seeking warmth for a relaxing evening, our Electric Heaters are designed to meet your needs. With user-friendly controls and efficient heating capabilities, these heaters not only add warmth but also create an inviting atmosphere that enhances the overall experience for everyone in attendance.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">At our service, we prioritize both functionality and style. Our Electric Heaters are not only powerful in terms of performance but also sleek and aesthetically pleasing, seamlessly blending into any setting. Make the most of your gatherings by ensuring your guests stay comfortable and cozy throughout the event. Contact us now to elevate your event experience with our Electric Heaters for sale in Pune, and let us help you create memorable moments in the warmth of a well-heated environment.</p>

                <p className="whyTxt mb-3 lh-sm text-gray">Transform your events in Pune into cool, comfortable affairs with our top-notch Air Coolers available for sale. Our eco-friendly cooling solutions are designed to enhance your event experience while keeping sustainability at the forefront. Beat the heat and create a pleasant atmosphere for your guests without breaking the bank. With our products, you not only get relief from soaring temperatures but also contribute to a greener, more environmentally conscious event.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Choosing our solutions means opting for a cost-effective and efficient cooling option that aligns with your commitment to sustainability. Our Air Coolers are not only energy-efficient but also use environmentally friendly cooling methods, ensuring minimal impact on the planet. Don't let the heat spoil your event; instead, create a refreshing ambiance that leaves a lasting impression. Contact us today to elevate your event cooling experience in Pune while making a positive contribution to the environment.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Are you in Pune or nearby areas and in need of top-notch Mist Fan Parts? Look no further! We pride ourselves on providing high-quality, genuine parts to ensure your Mist Fans remain in optimal condition. We understand the importance of reliable misting systems, especially in warm climates, and we're committed to offering parts that meet the highest standards.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Our extensive range of Mist Fan Parts is designed to cater to various needs, whether you require replacements or upgrades. Trust us to deliver not only the parts you need but also the assurance of durability and performance. With our commitment to quality, you can rest easy knowing that your misting system will continue to provide effective cooling and comfort. Don't compromise on the efficiency of your Mist Fan—choose us for genuine and reliable Mist Fan Parts in Pune and nearby locations.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">Contact us today to explore our range of Mist Fan Parts and experience the difference that genuine quality can make in keeping your Mist Fan operating at their best. Your satisfaction is our priority, and we are dedicated to being your trusted partner for all misting system needs.</p>
                <p className="whyTxt mb-3 lh-sm text-gray">We are your trusted partner for event materials in Pune and nearby locations. With a wide range of cooling and heating solutions, we ensure your event is a success. Experience the difference today!</p>
